...
const SurveySection = (props: Props) => {
  return (
    <div style={{ width: "100%", textAlign: "center" }}>
      <Button variant="contained" color="primary" disabled={!props.active} onClick={props.onHandle}>
...
const sectionHandler = () => {
  return (event: SyntheticEvent<>, ctx: React$ElementRef<typeof SurveyContainer>, idx: number) => {
